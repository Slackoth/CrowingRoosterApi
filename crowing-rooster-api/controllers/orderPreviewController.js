...
const getSuccessfulOrderPreview = async (req,res) => {
    ...
    await db.connection.any(`select o.codigo_orden, oe.fecha_entrega as fecha, sum(p.cantidad_bateria) as cantidad,
    ...
    group by o.codigo_orden, oe.fecha_entrega ,c2.codigo,b2.product_img ;`
    )
    .then(data => {
...
const getOngoingOrderPreview = async (req,res) => {
    ...
    await db.connection.any(`select o.codigo_orden, op.fecha_pendiente as fecha, sum(p.cantidad_bateria) as cantidad,
    o.estado,c2.codigo as comprador,b2.product_img as img
